...
void UILayer::Update()
{
    ...
    par.Smoothness = 2.0f;
    par.TextureSize = XMFLOAT2(4096, 4096);
    par.Time = totalTime;

    par.ColorShiftSpeed = 0.15f; // Скорость перехода
    par.NoiseIntensity = 0.01f; // Слабая текстура
